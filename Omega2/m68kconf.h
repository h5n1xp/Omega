 ...
 */
#define M68K_EMULATE_FC             OPT_OFF//OPT_SPECIFY_HANDLER //Amiga only has a single address space.
 ...
 * instruction.
 */
#define M68K_INSTRUCTION_HOOK       OPT_SPECIFY_HANDLER // - Disabled if we don't need the disassembler
